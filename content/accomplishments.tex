...
\newcommand\ibmAdsFirstAccomplishment{Created machine learning Covid-19 tool that reduced need for hospitalization identification}
...
\newcommand\ibmSdcaFourthAccomplishment{Created AI Surgical Scheduling Optimization tool currently evolving into new offering}
...
% ----------------------------------------------------------
% 		Software Developer
\newcommand\ibmSdFirstAccomplishment{Reduced time spent on knowledge transfer by \approx80\% by reorganizing project documentation}
...
% ----------------------------------------------------------
% 		Data Scientist
\newcommand\ibmDsFirstAccomplishment{Managaed team of 12 remote data science contractors for 36 integration projects}
...
% ----------------------------------------------------------
% 		Research Assistant
\newcommand\ucFirstAccomplishment{}
\newcommand\ucSecondAccomplishment{}
\newcommand\ucThirdAccomplishment{}