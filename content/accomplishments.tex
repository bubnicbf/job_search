...
% ----------------------------------------------------------
% 		Senior Data Analyst
\newcommand\arkosFirstAccomplishment{Used PowerBI and SQL to redeﬁne and track KPIs surrounding outcome QI initiatives.}
\newcommand\arkosSecondAccomplishment{Redesigned data model and implemented A/B tests to develop scoring models for outreach campaigns.}
\newcommand\arkosThirdAccomplishment{Built data models and maps to generate meaningful insights from patient data.}
\newcommand\arkosFourthAccomplishment{Devised KPIs using SQL across disparate databases in collaboration with cross-functional teams.}
...
\newcommand\merativeThirdAccomplishment{Developed scoring algorithm development for a machine learning saas solution.}
